...
export function ProductCard({
  ...
  return (
    <article className="group w-[220px] shrink-0 overflow-hidden rounded-2xl border border-line bg-white shadow-[0_1px_3px_rgba(15,23,42,0.05)] transition hover:shadow-[0_8px_24px_rgba(15,23,42,0.08)]">
